...
MODEL_PATH = "saved_models/best_regularized_model.pth"
...
# Important:
# Test data must NOT contain random augmentation.
...
plt.title(
    "Regularized CNN - Test Confusion Matrix"
)

plt.tight_layout()

plt.savefig(
    "results/regularized_confusion_matrix.png",
    dpi=300
)
